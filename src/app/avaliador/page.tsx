	...
	return (
		<main className="bg-white flex flex-col items-center min-h-screen space-y-10">
			...
			<div className="flex flex-col items-center px-4 py-6 space-y-6 istok-web-regular">
				<div className="px-3 py-4 w-[360px] md:w-[580px] bg-gray-100 rounded-md shadow-sm border border-gray-300">
					<p>Olá, <span className="font-semibold">{avaliador?.nome}</span></p>
					<p>Seja bem-vindo ao seu painel de avaliação, aqui vocês podem avaliar os trabalhos dos alunos.</p>
					<p>Para começar, <span className="font-semibold text-primary">clique no botão abaixo</span> para avaliar trabalhos.</p>
